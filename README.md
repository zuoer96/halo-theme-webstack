<div align="center">
<!-- 主题Logo -->
<img width="100px" src="https://nbchen.com/upload/avatar.jpg">
<!-- 主题名称 -->
<h1>Halo-Theme-WebStack</h1>
<!-- 主题徽章 -->
<p align="center">
  <!-- halo版本 -->
  ...
  <!-- 下载总数 -->
  <a href="https://github.com/zuoer96/halo-theme-webstack/releases"><img alt="下载总数" src="https://img.shields.io/github/downloads/zuoer96/halo-theme-webstack/total.svg?style=flat-square"/></a>
  <!-- 许可协议 -->
...
[Halo-Theme-WebStack](https://github.com/zuoer96/halo-theme-webstack)
是一款适用于 [Halo2.x](https://github.com/halo-dev/halo) 的博客主题。

移植自 [WordPress](https://wordpress.org/) 社区中 
的 [WebStack](https://github.com/WebStackPage/WebStackPage.github.io) 主题，作者是 [Viggo](https://www.viggoz.com)
...
1. **本主题依赖图库插件**
2. 如果安装主题后报错，请仔细查阅[主题说明](https://github.com/zuoer96/halo-theme-webstack)
   与[更新说明](https://github.com/zuoer96/halo-theme-webstack/releases)！！！
3. 如果还未解决，可以加群求助！！！
...
1. 在 [ Release](https://github.com/zuoer96/halo-theme-webstack/releases) 页面 `下载` 最新主题包 (zip)
...
1. 复制地址 `https://github.com/zuoer96/halo-theme-webstack`
...
[Halo-Theme-WebStack](https://github.com/zuoer96/halo-theme-webstack) 使用 [MIT](./LICENSE) 协议开源，请遵守开源协议。
